  ...
  return (
    <div className="p-5 text-black bg-white rounded">
      ...
      <Link
        ...
        className="flex items-end justify-center p-2 transition-all border-b border-black rounded-t bg-blue-50 gap-x-5 hover:bg-blue-100 hover:text-blue-500 hover:border-b-blue-500"
      >
